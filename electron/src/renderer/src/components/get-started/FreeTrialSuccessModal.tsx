...
interface FreeTrialSuccessModalPropsType {
  isOpen: boolean
  close: Function
}

export default function FreeTrialSuccessModal({ isOpen, close }: FreeTrialSuccessModalPropsType) {
    ...
    <Modal
      ...
      <Modal.Body className="">
        ...
        <div className="flex items-end">
          <div>
            {/* Title */}
            <h1 className="neutral-800 mt-3 text-lg font-semibold">Free Trial activated</h1>
            {/* Description */}
            <div className="mt-2 text-sm text-neutral-500">
              <p>Your free trial has been activated successfully.</p>
              <p>
                Enjoy trying out <span className="font-logo text-base font-bold text-logo">exifoo</span> with
                the demo version!
              </p>
            </div>
          </div>
          <div className="ml-2">
            <img src={ImgFreeTrialIllus} className="w-32 max-w-32" />
          </div>
        </div>
      </Modal.Body>
